    ...
    return (
        <>
            <div className = {Id === activeModal ? 'card-selected-medium' : 'card'}>
                <div className ='cardflip' style={{width: 100, height: 100, borderLeft: 'solid 4px #d2dae2', borderTop: `solid 4px ${randColor}`, borderBottom: 'solid 4px #808e9b', borderRight: 'solid 4px #808e9b', padding: '2px' }}>
                    <div className = 'cardfront' onClick = {() => modalAppear(Id)}>
                        <img src = {image} alt = '' style={{width: 100, height: 100}}/>
                    </div>
                    <div className = 'cardback' onClick = {clearModal}>
                        <img src = {door} alt = '' style={{width: 100/2, height: 100/2}}/>
                    </div>
                </div>
